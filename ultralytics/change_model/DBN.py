...
# paper: https://ieeexplore.ieee.org/document/9150780
class DiverseBranchNetwork(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size,
                 stride=1, padding=None, dilation=1, groups=1,
                 internal_channels_1x1_3x3=None,
                 deploy=False, single_init=False):
        super(DiverseBranchNetwork, self).__init__()
        self.deploy = deploy
...
class Bottleneck_DBN(Bottleneck):
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
        ...
        self.cv1 = DiverseBranchNetwork(c1, c_, k[0], 1)
        self.cv2 = DiverseBranchNetwork(c_, c2, k[1], 1, groups=g)
